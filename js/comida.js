const preguntas = [
    {
        pregunta: "'Big cheese'es una persona:",
        respuestas: ["Que se cree más que los demas ", "importante dentro de una empresa","Sin importancia", "Que habla mucho "],
        correcta: 1
    },
    {
        pregunta: " Que significa 'Egg on your face'",
        respuestas: ["Tener un problema psicológico", "Estar muy sucio","Sentirse avergonzado", "Ser romatico"],
        correcta: 2
    },
    {
        pregunta: "Que significa 'Bite off more than you can chew",
        respuestas: ["intentar hacer más de lo que puedes abarcar","Ser un inutil", "hablar con la boca llena", "morder a tu ser querido"],
        correcta: 0
    }
